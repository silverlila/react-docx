  ...
  >
    ...
    >
      ...
      <Paragraph alignment="center" spacing={{ after: 300 }}>
        ...
        <Break />
        <TextRun text="john.doe@email.com • github.com/johndoe • linkedin.com/in/johndoe" size={20} color="2B6CB0" />
      </Paragraph>
      ...
      <Paragraph spacing={{ after: 100 }}>
        ...
        <TextRun text="React, Next.js, Vue.js, HTML5, CSS3, Tailwind CSS" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 100 }}>
        <TextRun text="Backend: " bold={true} size={22} />
        <TextRun text="Node.js, Express, FastAPI, PostgreSQL, MongoDB, Redis" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 300 }}>
        <TextRun text="Tools: " bold={true} size={22} />
        <TextRun text="Git, Docker, Kubernetes, AWS, CI/CD, Jest, Playwright" size={22} />
      </Paragraph>
      ...
      <Paragraph spacing={{ after: 50, before: 150 }}>
        ...
        <Break />
        <TextRun text="Tech Innovations Inc. • San Francisco, CA" size={22} italics={true} />
        <Break />
        <TextRun text="January 2020 - Present" size={20} color="555555" />
      </Paragraph>

      <Paragraph spacing={{ after: 80, before: 80 }} indent={{ left: 360 }}>
        <TextRun text="• Led development of microservices architecture serving 2M+ daily active users" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 80 }} indent={{ left: 360 }}>
        <TextRun text="• Architected and implemented real-time collaboration features using WebSockets" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 80 }} indent={{ left: 360 }}>
        <TextRun text="• Reduced page load times by 60% through code splitting and lazy loading" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 250 }} indent={{ left: 360 }}>
        <TextRun text="• Mentored team of 5 junior developers and conducted technical interviews" size={22} />
      </Paragraph>
      ...
      <Paragraph spacing={{ after: 50 }}>
        ...
        <Break />
        <TextRun text="Digital Solutions Corp. • Palo Alto, CA" size={22} italics={true} />
        <Break />
        <TextRun text="June 2017 - December 2019" size={20} color="555555" />
      </Paragraph>

      <Paragraph spacing={{ after: 80, before: 80 }} indent={{ left: 360 }}>
        <TextRun text="• Developed responsive web applications using React and Redux" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 80 }} indent={{ left: 360 }}>
        <TextRun text="• Implemented automated testing increasing code coverage from 40% to 85%" size={22} />
      </Paragraph>

      <Paragraph spacing={{ after: 250 }} indent={{ left: 360 }}>
        <TextRun text="• Collaborated with UX designers to create accessible user interfaces" size={22} />
      </Paragraph>
      ...
      <Paragraph spacing={{ after: 50, before: 150 }}>
        <TextRun text="Bachelor of Science in Computer Science" bold={true} size={24} />
        <Break />
        <TextRun text="Stanford University • Stanford, CA" size={22} italics={true} />
        <Break />
        <TextRun text="Graduated: May 2017 • GPA: 3.8/4.0" size={20} color="555555" />
      </Paragraph>
    </Section>
  </Document>
);
